  ...
  if ( matchMedia( 'only screen and (min-width: 769px)' ).matches ) {
		$(window).scroll(function() {       
		   var $scrollHeight = $(window).scrollTop();
			  if ($scrollHeight > 120) {
        $('#header .top-header').addClass('addborder').slideDown(400);
				$('#header nav').addClass('addbg').slideDown(400);
			  } else {
        $('#header .top-header').removeClass('addborder');
...
//   ==========================================================
      ...
      $('.Overview').click(function(){
        $('#banner').fadeOut('fast').hide();
        $('#causes').fadeOut('fast').hide();
        $('#Types-Forms').fadeOut('fast').hide();
        $('#Resources').fadeOut('fast').hide();
        $('#overview').fadeIn('30').show();
      });
      $('.Causes').click(function(){
        $('#banner').fadeOut('fast').hide();
        $('#overview').fadeOut('fast').hide();
        $('#Types-Forms').fadeOut('fast').hide();
        $('#Resources').fadeOut('fast').hide();
        $('#causes').fadeIn('30').show();
      });
      $('.Types_forms').click(function(){
         $('#banner').fadeOut('fast').hide();
        $('#overview').fadeOut('fast').hide();
        $('#causes').fadeOut('fast').hide();
        $('#Resources').fadeOut('fast').hide();
        $('#Types-Forms').fadeIn('30').show();
      });
      $('.Resources').click(function(){
         $('#banner').fadeOut('fast').hide();
        $('#overview').fadeOut('fast').hide();
        $('#causes').fadeOut('fast').hide();
        $('#Resources').fadeIn('30').show();
      });
      $('.tac').click(function(){
        $('#banner').fadeOut('fast').hide();
        $('#overview').fadeOut('fast').hide();
      ...
      $('.faq').click(function(){
        ...
        $('#causes').fadeOut('fast').hide();
        $('#Resources').fadeOut('fast').hide();
        $('#TAC').fadeOut('fast').hide();
        $('#FAQ').fadeIn('30').show();
      });
      /*$('.Contact').click(function(){
        $('#banner').fadeOut().hide();
        $('#overview').fadeOut().hide();
        $('#causes').fadeOut().hide();
        $('#Resources').fadeOut().hide();
        $('#TAC').fadeOut().hide();
        $('#FAQ').fadeIn().hide();
        $('#contact-form').fadeIn().show();
        $('footer').show();
      });*/
